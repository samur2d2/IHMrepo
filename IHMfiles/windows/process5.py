def CreateProcess5Window(master, photo):
...
#============================================================================================== BOTORES DA JANELA DE NAVEGACAO
    ...
    buttonProcess2 = CreateNavigatorButtons("Process 2", 75)
    ...
    buttonProcess5 = CreateNavigatorButtons("Process 5", 270, color="#DCDBDB", fontColor="black")
